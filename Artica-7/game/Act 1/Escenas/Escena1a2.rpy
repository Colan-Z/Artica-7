label escena1a2:
    ...
    tutor "¡Chicos, hagan silencio y presten atención!"
    ...
    tutor "¡Son la élite!"
    tutor "En veinte minutos tocaremos suelo en Orcadas."
    ...
    tutor "Ahora, necesito que pongan los celulares en la mochila. Allá afuera no hay tiempo para distraerse."
