...
define estudiante_1 = Character("Aurora", color="#7033e2")
define estudiante_2 = Character("Zoe", color="#c8dc14")
define estudiante_3 = Character("Noah", color="#dc2114")
define estudiante_4 = Character("Liam", color="#14d5dc")
define estudiante_5 = Character("Elisa", color="#dc14b1")
define estudiante_6 = Character("Erik", color="#96dc14")
