...
label act_3_escena1:
    ...
    david "¡Qué hiciste!"
    show chris_enojado_ropa_rota_hacha at parpadear("chris_enojado_ropa_rota_hacha"), center
...
label calmar_a_chris:
    ...
    scene fondo comedor_desorden with fade
    show sara_ropa_rota at parpadear("sara_ropa_rota"), center
...
label intentar_calmar_a_chris:
    ...
    show chris_ropa_rota at parpadear("chris_ropa_rota"), right
    chris "..."
    ...
    david "Te necesito."
    show chris_ropa_rota_llorando at parpadear("chris_ropa_rota_llorando"), right
    chris "Yo... solo quería... protegerlos a todos. Como tú. Ser útil. Ser el héroe por una vez."
    show sara_ropa_rota at parpadear("sara_ropa_rota"), left
...
label huir_con_sara:
    ...
    show sara sonrisa at parpadear("sara sonrisa"), left
...
label transición_a_escena_final_malo:
    ...
    show chris_enojado_ropa_rota at parpadear("chris_enojado_ropa_rota"), center
    ...
    show sara_gritando_que_hiciste at parpadear("sara_gritando_que_hiciste"), right
    sara "¡QUÉ HICISTE!"
    hide sara_gritando_que_hiciste
    play sound "quiebre.mp3"
    show chris_arrepentido at parpadear("chris_arrepentido"), center
    pause
    ...
    show fondo sala_herramientas
    show chris_ropa_rota_llorando at parpadear("chris_ropa_rota_llorando"), center
    ...
    hide estudiante_masculino_rojo
    show sara_ropa_rota_rojo at parpadear("sara_ropa_rota_rojo"), center
    sara "¡El generador se apagó!"
    hide sara_ropa_rota_rojo
    show chris_ropa_rota_llorando_rojo at parpadear("chris_ropa_rota_llorando_rojo"), center
    chris "¡Por favor, no me dejes solo!"
    hide chris_ropa_rota_llorando_rojo
    show sara_ropa_rota_rojo at parpadear("sara_ropa_rota_rojo"), left
